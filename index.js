...
let client = new twilio(
  "ACf3a669cb14e5706b596c0f54d03a7762",
  "f664ece1ab61d291d08f2fcb40802bdd"
);
...
app.post("/chat", (req, res) => {
  ...
  if (req.body.EventType === "onConversationAdded") {
    ...
    client.conversations.v1
      ...
      .then((participant) =>
        console.log(
          `Added ${participant.identity} to ${req.body.ConversationSid}.`
        )
      )
      .catch((err) =>
        console.error(
          `Failed to add a member to ${req.body.ConversationSid}!`,
          err
        )
      );
  }
...
app.post("/outbound-status", (req, res) => {
  console.log(
    `Message ${req.body.SmsSid} to ${req.body.To} is ${req.body.MessageStatus}`
  );
  res.sendStatus(200);
});
